<script>
    ...
    import {  myAccommodation, tarifs, combinedData } from "../dataImport/dataEtale/informationEtale";
                ...
                <ul>
                    {#each equipements as equipement (equipement.nom)}
                        <li class="equipement-item">
                            <img class="equipements-img" src={equipement.image} alt={equipement.alt} />
                            {equipement.nom}
                        </li>
                    {/each}
                </ul>
...
>
    <div class="outdoor-equipment">
        <h2 class="outdoorH2" id="equipOutdoorHeading" aria-label="Équipement extérieur">Équipement extérieur</h2>
